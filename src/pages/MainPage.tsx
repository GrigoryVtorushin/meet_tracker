...
const MainPage = () => {
    ...
    return isAuth ? (
        <div className={'flex flex-row'}>
            <div style={{backgroundColor: '#18181B'}} className={` h-lvh max-w-96 transition-all duration-300 ${showLeftMenu ? 'translate-x-0 basis-2/5 fixed md:relative' : '-translate-x-full fixed'} `}>
                <LeftMenu
            ...
            <div className={'h-lvh w-full mx-0 sm:mx-4'}>
                {processingStarted
                    ...
                    : <UploadFile setProcessingStarted={setProcessingStarted}/>
                }
                {/*<Meeting className={'flex w-full h-full'}/>*/}
